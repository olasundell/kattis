...
class Dec14Test : AbstractKotlinTest() {
    ...
    fun simple() {
        ...
        val result = Dec14().solve(Scanner(s))
    ...
    @Test
    fun `harderer than still`() {
        val s = """2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG
...
176 ORE => 6 VJHF""".trimIndent()
    ...
    @Test
    fun `hardest of the test runs`() {
        val s = """171 ORE => 8 CNZTR
