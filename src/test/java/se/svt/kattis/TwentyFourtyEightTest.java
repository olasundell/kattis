...
public class TwentyFourtyEightTest extends AbstractTest {
    ...
    public void shouldGetCorrectTile() {
        int result = twentyFourtyEight.getTile(tempBoard, 0, 0, TwentyFourtyEight.Direction.LEFT);
        Assert.assertEquals(tempBoard[0][0], result);

        result = twentyFourtyEight.getTile(tempBoard, 0, 0, TwentyFourtyEight.Direction.RIGHT);
    ...
    public void shouldCreateSimpleBoard() {
        ...
        List<List<Integer>> result = twentyFourtyEight.createBoardFromTemp(tempBoard, TwentyFourtyEight.Direction.LEFT);
        Assert.assertEquals(expected, result);
    }
    ...
    public void shouldCreateAndRotateBoardRight() {
        ...
        List<List<Integer>> result = twentyFourtyEight.createBoardFromTemp(tempBoard, TwentyFourtyEight.Direction.RIGHT);
        Assert.assertEquals(expected, result);
    }
    ...
    public void shouldCreateAndRotateBoardUp() {
        ...
        List<List<Integer>> result = twentyFourtyEight.createBoardFromTemp(tempBoard, TwentyFourtyEight.Direction.UP);
        Assert.assertEquals(expected, result);
    }
    ...
    public void shouldCreateAndRotateBoardDown() {
        ...
        List<List<Integer>> result = twentyFourtyEight.createBoardFromTemp(tempBoard, TwentyFourtyEight.Direction.DOWN);
        Assert.assertEquals(expected, result);
    }

    @Test
    public void shouldPrint() {
        List<List<Integer>> boardDown = twentyFourtyEight.createBoardFromTemp(tempBoard, TwentyFourtyEight.Direction.DOWN);
        String result = twentyFourtyEight.printBoard(boardDown, TwentyFourtyEight.Direction.DOWN);
        List<List<Integer>> boardLeft = twentyFourtyEight.createBoardFromTemp(tempBoard, TwentyFourtyEight.Direction.LEFT);
        String expected = twentyFourtyEight.printBoard(boardLeft, TwentyFourtyEight.Direction.LEFT);
        Assert.assertEquals(expected, result);
    }
